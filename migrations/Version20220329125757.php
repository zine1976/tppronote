 ...
 */
final class Version20220329125757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note_eleve (note_id INT NOT NULL, eleve_id INT NOT NULL, INDEX IDX_89B1A62026ED0855 (note_id), INDEX IDX_89B1A620A6CC7B2 (eleve_id), PRIMARY KEY(note_id, eleve_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
